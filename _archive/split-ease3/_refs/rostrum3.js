...
if (timeBase == 'abs') { 
	...
	// 	easeDur2 *= downscale; 
	// }
	var scale = (easeSum > totalDur) ? (totalDur / easeSum) : 1;
	var relEaseDur1 = (easeDur1 *= scale) / totalDur;
	var relEaseDur2 = (easeDur2 *= scale) / totalDur;
}
...
console.log('Ease 1: ' + easeDur1 + ' seconds or ' + relEaseDur1 + ' of whole.');
console.log('Ease 2: ' + easeDur2 + ' seconds or ' + relEaseDur2 + ' of whole.');
