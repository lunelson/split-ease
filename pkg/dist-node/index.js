...
function SplitEase(et1, et2, opts) {
  ...
  const eSum = et1 + et2;
  if (et1 > 1) console.warn(`SplitEase: ease-in ratio is > 1 [${et1}]; both ratios will be scaled down`);else if (et2 > 1) console.warn(`SplitEase: ease-out ratio is > 1 [${et2}]; both ratios will be scaled down`);else if (eSum > 1) console.warn(`SplitEase: total easing ratio is > 1 [${eSum}]; both ratios will be scaled down`);
